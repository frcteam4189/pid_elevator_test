...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    OI.camera.setVideoMode(VideoMode.getPixelFormatFromInt(1), 100, 100, 30);
    //driveSubsystem.compressor.setClosedLoopControl(true);
  }
  ...
  public void teleopInit() {
    ...
    // }
    // if(OI.upElevatorH2PID.get()) {
    //   Robot.elevator.setSetpoint(10);
    // }
    // if(OI.upElevatorH3PID.get())  {
    //   Robot.elevator.setSetpoint(15);
    // }
